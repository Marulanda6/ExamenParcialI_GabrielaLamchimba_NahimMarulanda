...
public class GestionLibrosGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Titulo", "Código ", "Año de publicación", "Autor", "Bibliografia del autor", "Nacionalidad del autor"
            }
        ) {
    ...
    // Crear el nombre completo del autor
    String autor = nombreAutor + " " + apellidoAutor;

    // Agregar una nueva fila a la tabla
    javax.swing.table.DefaultTableModel model = (javax.swing.table.DefaultTableModel) jTable1.getModel();
    model.addRow(new Object[]{titulo, codigo, anioPublicacion, autor, bibliografiaAutor, nacionalidadAutor });
